...
class Current_User():
    ...
    def serv(self):
        ...
        BTNP.grid(row=3, column=1)
        BTNF = tkinter.Button(self.servW, text="Fawry Service", width=15, command=self.fawryInit)
    ...
    def fawryInit(self):
        ...
        while i < col_num:
            ...
            i += 1
        BTNO = tkinter.Button(self.fawryW, text="Orange Recharge", width=15, command=self.fawryChargeBtn)
        BTNO.grid(row=1, column=1)
        BTNE = tkinter.Button(self.fawryW, text="Etisalat Recharge", width=15, command=self.fawryChargeBtn)
        ...
        BTNW = tkinter.Button(self.fawryW, text="We Recharge", width=15, command=self.fawryChargeBtn)
